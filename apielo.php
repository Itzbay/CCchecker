...
elseif 
(strpos($result3,  '-1')) {
  echo "<font size=2 color='black'>  <font class='badge badge-danger'> Reprovada | $cc|$mes|$ano|$cvv </span></i></font> <br> <font size=2 color='black'><font class='badge badge-light'> Update Nonce ◣◥◤◢◣ ◥◤  [ 𝗣𝗘𝗚𝗔𝗦𝗨𝗦  𝗔𝗨𝗧𝗛  𝟭  𝗕𝗬 @𝗹𝗶𝘃𝗶𝗻𝗴𝗵𝘂𝗺𝗮𝗻𝗼𝗶𝗱 ] ◥◤◢◣◥◤◥ )]</i></font> <br> <font class='badge badge-primary'>$bank [$country] - $type</i></font> <br>";
}

else {
  echo "<font size=2 color='black'>  <font class='badge badge-danger'> Reprovada | $cc|$mes|$ano|$cvv </span></i></font> <br> <font size=2 color='red'><font class='badge badge-light'>Card was Reprovada due to an Unknown Error ◣◥◤◢◣ ◥◤  [ 𝗣𝗘𝗚𝗔𝗦𝗨𝗦  𝗔𝗨𝗧𝗛  𝟭  𝗕𝗬 @𝗹𝗶𝘃𝗶𝗻𝗴𝗵𝘂𝗺𝗮𝗻𝗼𝗶𝗱 ] ◥◤◢◣◥◤◥ )] </i></font><br> <font class='badge badge-primary'>$bank [$country] - $type</i></font><br>";
}
